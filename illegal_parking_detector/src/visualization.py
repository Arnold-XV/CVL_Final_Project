...
def main():
    ...
    visualizer = VisualizationOutputModule(
    ...
    while True:
        ...
        # Example data from previous modules
        ...
        for vehicle in detected_vehicles:
            ...
            frame = visualizer.draw_vehicle_info(
                frame=frame,
                vehicle_id=vehicle["id"],
                bbox=vehicle["bbox"],
                status=vehicle["status"],
                stopped_duration=vehicle["duration"]
            )

            # Log illegal parking
            if vehicle["status"] == "ILLEGAL PARKING":

                visualizer.log_violation(
                    vehicle_id=vehicle["id"],
                    duration_stopped=vehicle["duration"]
                )

        # Draw system statistics
        frame = visualizer.draw_statistics(
            frame,
            frame_count
        )
